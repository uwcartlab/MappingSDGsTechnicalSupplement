...
![](1.09_Visual_Accenting_images/image_0.png)
...
Right click *UN_wom_par_eiv* in the *Layers* panel and click *Attribute Table*. Click on the icon of an E over a yellow square (![](1.09_Visual_Accenting_images/image_1.png)) which allows you to *Select features using an expression*. 
...
![](1.09_Visual_Accenting_images/image_2.png)
...
Deselect features from *UN_wom_par_eiv*. At the top of the screen *Deselect Features from All Layers*. by clicking the icon of the yellow square next to the red cancel sign (![](1.09_Visual_Accenting_images/image_3.png)).
