## Tutorial 1.9: Labeling and Leader Lines

**Summary**

**Tutorial 1.9** demonstrates how to add ***labels*** to the accented countries *(Figure 1.9-1)*.

> ***Label***: map text (see **Section 2.11**)

![](1.09_Labels_images/image_0.png)

*Figure 1.9-1: Map labels with leader lines.*
...
Next, to edit the labels, click the button with abc next to a yellow pencil (![](1.09_Labels_images/image_1.png)) to *Change Label Properties*.
...
In the Label Toolbar, find the *Move Label or Diagram* option, which looks like the letters abc next to an arrow (![](1.09_Labels_images/image_2.png)). Click on this option, and then click on a label.
...
Now you have labeled the accented countries with leader lines. Save and proceed to [**Tutorial 1.10**: Adding Elements to Layout View](/1_Choropleth/1.10_Layout.md).
