## Tutorial 1.8: Visual Accenting

**Summary**

**Tutorial 1.8** demonstrates how to add bold borders to make important data stand out *(Figure 1.8-1)*. The map is looking pretty good right now. If you wanted, you could add a title and legend and be done!

![](1.08_Visual_Accenting_images/image_0.png)

###### Figure 1.8-1: Visual accenting for countries with greater than 50.0% women in parliament.
...
Right click *UN_wom_par_eiv* in the *Layers* panel and click *Attribute Table*. Click on the icon of an E over a yellow square (![](1.08_Visual_Accenting_images/image_1.png)) which allows you to *Select features using an expression*. 
...
![](1.08_Visual_Accenting_images/image_2.png)
...
Deselect features from *UN_wom_par_eiv*. At the top of the screen *Deselect Features from All Layers*. by clicking the icon of the yellow square next to the red cancel sign (![](1.08_Visual_Accenting_images/image_3.png)).
...
Now you have added bold borders to the countries with the highest values. Save and proceed to [**Tutorial 1.9**: Labeling and Leader Lines](/1_Choropleth/1.09_Labels.md).
