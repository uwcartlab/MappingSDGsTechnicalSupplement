## Tutorial 1.12: Advanced Layout Styling

**Summary**

**Tutorial 1.12** demonstrates how to change a few of the existing elements to be more stylistically appealing (*Figure 1.12-1*). This lesson will match the map as it appears in the *Mapping for a Sustainable World* book, but feel free to continue experimenting on your own.

![](1.12_Advanced_Layout_images/image_0.png)

###### Figure 1.12-1: Choropleth map layout with additional stylistic features.
...
Note that the use of red and green together in a map can cause issues for people who are red/green colourblind (*Figure 1.12-2*, see **Section 4.2**). Never use red and green together to symbolize *data*. However, in this map data is green, and red is only used as a stylistic element for the title.

![](1.12_Advanced_Layout_images/image_1.png)

###### Figure 1.12-2: Improper colour scheme for visually impaired individuals, book Figure 4.2-1.
...
At this point, your map is looking a lot like the one in *Mapping for a Sustainable World*! You could also add the other supplementary text by using *Add Label* again. Other, more advanced features like the addition of a drop shadow (the shadow behind the countries) and the addition of graphs (*Figure 1.12-3, *see **Section 3.10**) require additional software, such as Inkscape or Adobe Illustrator.

![](1.12_Advanced_Layout_images/image_2.png)

###### Figure 1.12-3: Non-map graphics, book Figure 3.10-1.

You have now completed the choropleth map tutorial. If you would like to learn how to make a proportional symbol map (a different thematic map), proceed to [**Tutorial 2.1**: Overview and Setup](/2_Proportional_Symbol/2.01_proportional_setup.md).
