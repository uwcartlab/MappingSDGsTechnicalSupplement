...
![](1.07_Edit_Attribute_table_Map_Algebra_images/image_0.png)
...
![](1.07_Edit_Attribute_table_Map_Algebra_images/image_1.png)
...
![](1.07_Edit_Attribute_table_Map_Algebra_images/image_2.png)
...
Enter editing mode by clicking on the pencil (![](1.07_Edit_Attribute_table_Map_Algebra_images/image_3.png)) to *Toggle editing mode*. 

Above the data, click on the *Field Calculator* (![](1.07_Edit_Attribute_table_Map_Algebra_images/image_4.png)). It is the fourth icon from the right. Create a new field (column). 
...
![](1.07_Edit_Attribute_table_Map_Algebra_images/image_5.png)
...
![](1.07_Edit_Attribute_table_Map_Algebra_images/image_6.png)
...
Click on the number next to the row for Antarctica. Click red trash can (![](1.07_Edit_Attribute_table_Map_Algebra_images/image_7.png)) to *Delete selected features*. Click the pencil to save your edits.

Close the attribute table.

Your data is now in a normalized format. Save and proceed to [**Tutorial 1.8**: Classifying Attribute Data](/1_Choropleth/1.08_Classify_Data.md).
