...
Click the green plus sign (![](1.06_Add_Data_images/image_1.png)). Join the data in this file to your csv *unwp*.
...
Now you have added all the necessary layers and joined them together. Save and proceed to [**Tutorial 1.7**: Editing the Attribute Table](/1_Choropleth/1.07_Edit_Attribute_table_Map_Algebra.md).
