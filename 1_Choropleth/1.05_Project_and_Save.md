...
Click the icon with three dots (![](1.05_Project_and_Save_images/image_1.png)) toward the right of the screen. Navigate to your *SDG_choropleth_tutorial* folder. Select the *UN_Countries_GDB.gdb* folder and then click *Add*.

![](1.05_Project_and_Save_images/image_6.png)
