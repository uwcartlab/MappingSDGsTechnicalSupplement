...
Save the file in your project folder. Unzip the file to access its contents. The main file you will need is **BNDA.shp** and its associated files of the same name with different file types. If you do not have a program that can zip and unzip (sometimes called "compress" and "uncompress") zip files, download the open source *[7zip](https://www.7-zip.org/download.html)* program to do so. We will open the files in [**Tutorial 1.5**](/1_Choropleth/1.05_Project_and_Save.md).
