...
Tutorials: [**Tutorial 1.8**: Classifying Attribute Data](/1_Choropleth/1.08_Classify_Data.md)
...
Once you have a dataset for the students to use, ask them to manipulate the classification of the data, similar to [**Tutorial 1.8**: Classifying Attribute Data](/1_Choropleth/1.08_Classify_Data.md). Second, ask the students to change the colour of the classification scheme, referencing **Section 2.10**: Colour.
