...
Import the *BNDA_simplified.shp* from the Geodatabase. Refer to [**Tutorial 1.5**](/1_Choropleth/1.05_Project_and_Save.md) for more detail.
...
Change the projection for the project and the file, similar to [**Tutorial 1.5**](/1_Choropleth/1.05_Project_and_Save.md). Name the projected shapefile *reprojected_map_europe_albers.shp*.
