...
![](2.03_select_europe_and_centroids_images/image_0.png)
...
![](2.03_select_europe_and_centroids_images/image_1.png)
...
You have now exported the European countries as a separate layer. Save and proceed to [**Tutorial 2.4**: Setting Proportional Symbols](/2_Proportional_Symbol/2.04_proportional_symbol.md).
