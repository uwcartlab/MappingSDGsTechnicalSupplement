...
![](2.06_legend_images/image_0.png)
...
Third, if you have vector editing software like Inkscape or Adobe Illustrator, you can design your own legend.
...
Click *Manual size classes*. Click the green plus to add circles for *100*, *1000*, *5000*, and *8983*. Note that the maximum value is different from the example in the book because you are using more recent data, from 2020, while the book uses data from 2016.
...
Consult [**Tutorial 1.9**](/1_Choropleth/1.9_Labels.md) if you need a refresher on labeling features.
...
Now you have learned to make a legend for a proportional symbol map. Save and proceed to [**Tutorial 2.7**: Advanced Layout Styling](/2_Proportional_Symbol/2.07_layout.md).
